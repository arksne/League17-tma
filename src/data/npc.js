export const NPC_DATA = {
  ...
  'goldenrod_academy_soren': {
    ...
    dialog: { greet: 'Я инструктор Сорен из Академии Тренеров.', default: 'Практикум по Эволюции ждёт тебя! Обратись к Лаборанту на Тренировочной зоне.', quest_offer: 'Принеси мне {target} {item} для эволюционного эксперимента.', quest_complete: 'Отлично! Эволюция удалась!', quest_incomplete: 'Нужно больше монстров для эксперимента.' },
  ...
  'lavender_miss_trevis': { id: 'lavender_miss_trevis', name: 'Мисс Тревис', sprite: '👩‍🏫', location: 'lavender_town', dialog: { greet: 'Лавандия — город упокоения.', default: 'В окрестностях неспокойно... Дикие монстры атакуют!', quest_offer: 'Офицер Джес из Западного Шаффрана просила помощи. Принеси {target} {item}.', quest_complete: 'Спасибо! Лавандия снова в безопасности!', quest_incomplete: 'Монстры всё ещё атакуют...' }, quests: [{ id: 'lavender_terror', type: 'explore', targetItem: null, targetQty: 3, desc: 'Разберитесь в причине нападений диких монстров в Лавандии — посетите 3 локации', rewardMoney: 0, rewardItem: 'tm', rewardQty: 1, prereqQuest: null }] },
  ...
  'sel_route8_prof_sten': { id: 'sel_route8_prof_sten', name: 'Профессор Стэн', sprite: '🔬', location: 'estaire_daycare_center', dialog: { greet: 'Профессор Стэн. Я изучаю легендарных монстров.', default: 'Перо легендарного монстра — вот что мне нужно!', quest_offer: 'Найди доказательство существования легендарного монстра: принеси {target} {item}.', quest_complete: 'Это оно! Легенда реальна! Спасибо, исследователь!', quest_incomplete: 'Поиски продолжаются. Легендарный монстр где-то там...' }, quests: [{ id: 'sel_legend_feather', type: 'collect_items', targetItem: 'lavaCore', targetQty: 3, desc: 'Принесите 3 ядра магмы — возможные останки легендарного монстра', rewardMoney: 8000, rewardItem: 'dawnStone', rewardQty: 2, prereqQuest: 'ost_mayor_war' }] },
  ...
  'selen_adventurer': { id: 'selen_adventurer', name: 'Искатель приключений', sprite: '🧭', location: 'selen_forest', dialog: { greet: 'В этом лесу я нашёл следы легендарного монстра!', default: 'Логово дракона — моя цель. Но нужна помощь.', quest_offer: 'Помоги найти Око Мироздания: принеси {target} {item}.', quest_complete: 'Око Мироздания найдено! Легенда оживает!', quest_incomplete: 'Поиски продолжаются... Око где-то в мире.' }, quests: [{ id: 'sel_dragon_lair', type: 'explore', targetItem: null, targetQty: 6, desc: 'Отыщите Око Мироздания — посетите 6 локаций в разных регионах', rewardMoney: 10000, rewardItem: 'masterBall', rewardQty: 3, prereqQuest: null }] },
  ...
  'elite_lorelei': { id: 'elite_lorelei', name: 'Лорели', sprite: '❄️', location: 'indigo_plateau', dialog: { greet: 'Я Лорели, член Элитной Четвёрки. Ледяные покемоны не знают пощады.', default: 'Холод — это то, что ты почувствуешь, когда встретишь меня в бою.' }, quests: [] },
  'elite_bruno': { id: 'elite_bruno', name: 'Бруно', sprite: '💪', location: 'indigo_plateau', dialog: { greet: 'Я Бруно! Мои покемоны боевого типа сокрушат любого!', default: 'Тренировки делают нас сильнее. Ты готов?' }, quests: [] },
  'elite_agatha': { id: 'elite_agatha', name: 'Агата', sprite: '👻', location: 'indigo_plateau', dialog: { greet: 'Хе-хе... Я Агата. Призраки — мои верные спутники.', default: 'Смерть неизбежна, как и моя победа.' }, quests: [] },
  'elite_lance': { id: 'elite_lance', name: 'Лэнс', sprite: '🐉', location: 'indigo_plateau', dialog: { greet: 'Я Лэнс, мастер драконьих покемонов. Элитная Четвёрка — моя стихия.', default: 'Драконы — сильнейшие покемоны. Ты готов это проверить?' }, quests: [] },
  'elite_champion': { id: 'elite_champion', name: 'Чемпион Блю', sprite: '👑', location: 'indigo_plateau', dialog: { greet: 'Я Чемпион Лиги! Мой дед — профессор Оук. Докажи, что достоин.', default: 'Быть чемпионом — значит быть сильнейшим. Попробуй отобрать титул!' }, quests: [] },
