import { 
  getSocialState, setTrainerNickname, openTrainerProfile, lsKey, renderTrainerCard, autoSave, showToast, escHtml 
} from '../../main.js';
...
export function initTrainersTab() {
  ...
  if (saveBtn) {
    saveBtn.addEventListener('click', () => {
      setTrainerNickname(document.getElementById('account-nickname').value.trim());
